...
2. `article_aware/figures/figure_N_visual_checklist.md` — a panel-by-panel checklist of
   ...
   a generated figure matches the paper.

These two files are complementary: the `figure_N.md` explains *why* each panel looks the
way it does (grounded in model equations and citations); the checklist specifies *what* to
look for when doing a visual comparison.
